    ...
    public class HomeController : Controller
    {
        public string Index()
        {
            using (var context = new MemberContext())
            {
                ...
                context.MemberList.Add(new Member { Name = "Lulu Misrahi", Seniority = 2 });
                context.MemberList.Add(new Member { Name = "Yael Misrahi", Seniority = 3 });
                context.MemberList.Add(new Member { Name = "Orit Misrahi", Seniority = 4 });
