...
namespace RegistrationDemo.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            RegisterMemberViewModel rvm = new RegisterMemberViewModel
            {
        ...
        [HttpPost]
        public ActionResult Register(RegisterMemberViewModel member)
        {
            if (ModelState.IsValid)
            {
                Repository.Add(member.MemberData);
                return RedirectToAction("Index");
            }
            else
            {
                return View(new RegisterMemberViewModel { MemberData = member.MemberData, Cities = CityRepository.Cities });
            }
        }
