...
namespace Client.StockService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="StockService.StockService")]
    public interface StockService {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/StockService/GetAllProducts", ReplyAction="http://tempuri.org/StockService/GetAllProductsResponse")]
        Client.StockService.Product[] GetAllProducts();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/StockService/GetAllProducts", ReplyAction="http://tempuri.org/StockService/GetAllProductsResponse")]
        System.Threading.Tasks.Task<Client.StockService.Product[]> GetAllProductsAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/StockService/AddProduct", ReplyAction="http://tempuri.org/StockService/AddProductResponse")]
        void AddProduct(string productName, int amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/StockService/AddProduct", ReplyAction="http://tempuri.org/StockService/AddProductResponse")]
        System.Threading.Tasks.Task AddProductAsync(string productName, int amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/StockService/AddAmount", ReplyAction="http://tempuri.org/StockService/AddAmountResponse")]
        void AddAmount(int productID, int amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/StockService/AddAmount", ReplyAction="http://tempuri.org/StockService/AddAmountResponse")]
        System.Threading.Tasks.Task AddAmountAsync(int productID, int amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/StockService/SubAmount", ReplyAction="http://tempuri.org/StockService/SubAmountResponse")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface StockServiceChannel : Client.StockService.StockService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StockServiceClient : System.ServiceModel.ClientBase<Client.StockService.StockService>, Client.StockService.StockService {
