...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlFavoriteActivity"
            EnableClientScript="False" ErrorMessage="RequiredFieldValidator" InitialValue="Choose">Choose an activity</asp:RequiredFieldValidator>
		 <br />
		 <br />
		 <br />
